...
import { transmitDTE, signDTE } from '../../infrastructure/hacienda/hacienda.client';
import { generateInvoicePdf } from '../../infrastructure/pdf/pdfGenerator.service';
import { sendDTEEmail } from '../../infrastructure/email/email.service';
import { v4 as uuidv4 } from 'uuid';
import path from 'path';
import fs from 'fs';
import { uploadToAzureBlob } from '../../infrastructure/storage/storage.service';
